...
// Chapter data with verse counts and starting page numbers (Madinah Mushaf)
export const chapters = [
  ...
  { id: 15, name: 'Al-Hijr', verses: 99, page: 262 },
  ...
  { id: 37, name: 'As-Saffat', verses: 182, page: 446 },
  { id: 38, name: 'Sad', verses: 88, page: 453 },
  ...
  { id: 44, name: 'Ad-Dukhan', verses: 59, page: 496 },
  { id: 45, name: 'Al-Jathiya', verses: 37, page: 499 },
  { id: 46, name: 'Al-Ahqaf', verses: 35, page: 502 },
  { id: 47, name: 'Muhammad', verses: 38, page: 507 },
  ...
  { id: 69, name: 'Al-Haqqa', verses: 52, page: 566 },
  { id: 70, name: "Al-Ma'arij", verses: 44, page: 568 },
  { id: 71, name: 'Nuh', verses: 28, page: 570 },
  { id: 72, name: 'Al-Jinn', verses: 28, page: 572 },
  { id: 73, name: 'Al-Muzzammil', verses: 20, page: 574 },
  { id: 74, name: 'Al-Muddaththir', verses: 56, page: 575 },
  { id: 75, name: 'Al-Qiyama', verses: 40, page: 577 },
  { id: 76, name: 'Al-Insan', verses: 31, page: 578 },
  { id: 77, name: 'Al-Mursalat', verses: 50, page: 580 },
  { id: 78, name: "An-Naba'", verses: 40, page: 582 },
  { id: 79, name: "An-Nazi'at", verses: 46, page: 583 },
  { id: 80, name: 'Abasa', verses: 42, page: 585 },
  { id: 81, name: 'At-Takwir', verses: 29, page: 586 },
  { id: 82, name: 'Al-Infitar', verses: 19, page: 587 },
  { id: 83, name: 'Al-Mutaffifin', verses: 36, page: 587 },
  { id: 84, name: 'Al-Inshiqaq', verses: 25, page: 589 },
  { id: 85, name: 'Al-Buruj', verses: 22, page: 590 },
  { id: 86, name: 'At-Tariq', verses: 17, page: 591 },
  { id: 87, name: "Al-A'la", verses: 19, page: 591 },
  { id: 88, name: 'Al-Ghashiya', verses: 26, page: 592 },
  { id: 89, name: 'Al-Fajr', verses: 30, page: 593 },
  { id: 90, name: 'Al-Balad', verses: 20, page: 594 },
  { id: 91, name: 'Ash-Shams', verses: 15, page: 595 },
  { id: 92, name: 'Al-Lail', verses: 21, page: 595 },
  { id: 93, name: 'Ad-Duha', verses: 11, page: 596 },
  { id: 94, name: 'Ash-Sharh', verses: 8, page: 596 },
  { id: 95, name: 'At-Tin', verses: 8, page: 597 },
  { id: 96, name: "Al-'Alaq", verses: 19, page: 597 },
  { id: 97, name: 'Al-Qadr', verses: 5, page: 598 },
  { id: 98, name: 'Al-Bayyina', verses: 8, page: 598 },
  { id: 99, name: 'Az-Zalzala', verses: 8, page: 599 },
  { id: 100, name: "Al-'Adiyat", verses: 11, page: 599 },
  { id: 101, name: "Al-Qari'a", verses: 11, page: 600 },
  { id: 102, name: 'At-Takathur', verses: 8, page: 600 },
  { id: 103, name: "Al-'Asr", verses: 3, page: 601 },
  { id: 104, name: 'Al-Humaza', verses: 9, page: 601 },
  { id: 105, name: 'Al-Fil', verses: 5, page: 601 },
  { id: 106, name: 'Quraish', verses: 4, page: 602 },
  { id: 107, name: "Al-Ma'un", verses: 7, page: 602 },
  { id: 108, name: 'Al-Kauthar', verses: 3, page: 602 },
  { id: 109, name: 'Al-Kafirun', verses: 6, page: 603 },
  { id: 110, name: 'An-Nasr', verses: 3, page: 603 },
  { id: 111, name: 'Al-Masad', verses: 5, page: 603 },
  { id: 112, name: 'Al-Ikhlas', verses: 4, page: 604 },
  { id: 113, name: 'Al-Falaq', verses: 5, page: 604 },
  { id: 114, name: 'An-Nas', verses: 6, page: 604 },
];
